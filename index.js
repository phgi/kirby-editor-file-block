...
},{}],"components/FileBlock.vue":[function(require,module,exports) {
"use strict";
...
var _default = {
  ...
  methods: {
    linkText: function linkText(html) {
      this.input({
        linkText: html
      });
    },
...
exports.default = _default;
        var $4fb35c = exports.default || module.exports;
      
      if (typeof $4fb35c === 'function') {
        $4fb35c = $4fb35c.options;
      }
    
        /* template */
        Object.assign($4fb35c, (function () {
          var render = function() {
  var _vm = this
  ...
  return _c(
    "div",
    { staticClass: "k-editor-file-block-wrapper" },
    [
      _vm.attrs.src
        ? [
            _c(
              "div",
              { staticClass: "k-editor-file-block-inner" },
              [
                _c(
                  "div",
                  {
                    ref: "element",
                    staticClass: "k-editor-file-block-file",
                    style: _vm.style,
                    attrs: { tabindex: "0" },
                    on: {
                      keydown: [
                  ...
                  [
                    _c(
                      ...
                      {
                        ref: "element",
                        staticClass: "k-editor-file-block-filename"
                      },
                      [_vm._v(_vm._s(_vm.attrs.id))]
                    )
                  ]
                ),
                _vm._v(" "),
                _c("k-editable", {
                  staticClass: "k-editor-file-block-linktext",
                  attrs: {
                    content: _vm.attrs.linkText,
                    breaks: true,
                    placeholder:
                      _vm.$t("editor.blocks.file.linkTextPlaceholder") + "…"
                  },
                  on: {
                    prev: _vm.focus,
                    shiftTab: _vm.focus,
            ...
            _c(
              ...
              [
                _c(
                  ...
                  {
                    ref: "element",
                    staticClass: "k-editor-file-block-placeholder",
                    attrs: { tabindex: "0" },
                    on: { drop: _vm.onDrop },
                    nativeOn: {
                      keydown: [
                  ...
                  [
                    _c(
                      ...
                      [_vm._v(_vm._s(_vm.$t("editor.blocks.file.upload")))]
                    ),
                    _vm._v(
                      "\n          " +
                        _vm._s(_vm.$t("editor.blocks.file.or")) +
                        "\n          "
                    ),
                    _c(
                      "k-button",
                      ...
                      [_vm._v(_vm._s(_vm.$t("editor.blocks.file.select")))]
                    )
                  ],
                  1
                )
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$4fb35c', $4fb35c);
          } else {
            api.reload('$4fb35c', $4fb35c);
          }
        }
...
var _FileBlock = _interopRequireDefault(require("./components/FileBlock.vue"));

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

editor.block("file", _FileBlock.default);
},{"./components/FileBlock.vue":"components/FileBlock.vue"}],"../../../../.config/yarn/global/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
